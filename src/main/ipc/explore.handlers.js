...
export function register(ipcMain, deps) {
  ...
  ipcMain.handle('yt:setCountry', createHandler('yt:setCountry', async (_event, countryCode) => {
  ...
  ipcMain.handle('yt:explore', createHandler('yt:explore', async () => {
    const ytmusic = getYtMusic();
  ...
  ipcMain.handle('yt:charts', createHandler('yt:charts', async () => {
    const ytmusic = getYtMusic();
  ...
  ipcMain.handle('yt:browseMood', createHandler('yt:browseMood', async (_event, browseId, params) => {
    const ytmusic = getYtMusic();
  ...
  ipcMain.handle('yt:getPlaylistVideos', createHandler('yt:getPlaylistVideos', async (_event, browseId) => {
    const ytmusic = getYtMusic();
